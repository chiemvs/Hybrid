...
from Hybrid.verification import load_tganom_and_compute, load_tgex_and_compute, build_fit_nn_model, load
...
total = build_fit_nn_model(predictandname = 'tg-anom_JJA_45r1_21D-roll-mean_q05_sep12-15', npreds = 4)
